...
export default function articleSection(attr,article){
    ...
    <div class="grid-container article-details">
        <div class=" title-summary-section">
            ...
            <div class="summary dt text-primary ${attr.summary}">
                <p>${article.summary}</p>
            </div> 
        </div>
        <div class="article-img ${attr.image}">
            <img src=${article.image}>
        </div>
        <div class="flex-container article-footer  ${attr.footer}">
            <p class="read-time muted-text">${article.read}min read</p>
